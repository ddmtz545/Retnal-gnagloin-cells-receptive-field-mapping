...
%%%%%%%%%
% on 17/07/2024 I modified this line(344) and tranposed the 'MEA_responsive_map';  MEA_Bar_gh_amp_rn_Nan = nanmean(MEA_responsive_map');

% %%%%assign the neuron index  this line transferred to 05 data parser
% Neuron_index_hori=21;
...
%%%%%actually it removes channels that are zero
% figure;heatmap(MEA_map,'Colormap',jet)
% title('average of only responsive neurons')
% Replace zero elements with NaN
MEA_map(MEA_map == 0) = NaN;
...
%%
% Display unique elements and their counts (number of responsive neurons)
...
RC_hori_map = abc{Neuron_index_hori,4};
